  ...
  "admissions": [
    {
      ...
      "zhConcept": "大學申請不是只有填志願。你需要理解第一階段、第二階段、備審資料、面試與科系需求。AI 可以協助你整理資訊、建立準備清單與模擬面試，但不能替你捏造經歷或保證錄取。本課重點是讓你知道整個申請流程，避免準備方向錯誤。",
      "enConcept": "University application is not just filling in choices. You need to understand the first stage, second stage, application materials, interviews, and major requirements. AI can help organize information, build preparation checklists, and simulate interviews, but it cannot invent experience or guarantee admission.",
      "zhPrompt": "請你擔任高中升學顧問，用高中三年級學生能理解的方式解釋：\n1. 大學申請第一階段是什麼\n2. 第二階段是什麼\n3. 備審資料為什麼重要\n4. 面試通常在看什麼\n5. 我現在應該先準備哪些資料\n請用表格整理，最後給我一份 7 天準備清單。",
      "enPrompt": "Act as a university admissions counselor. Explain in a way a high school senior can understand:\n1. What the first stage is\n2. What the second stage is\n3. Why application materials matter\n4. What interviews usually evaluate\n5. What I should prepare first\nUse a table and give me a 7-day preparation checklist.",
      "zhExample": "如果你想申請資訊管理系，AI 可以幫你列出：需要強調的能力、可能面試題、備審資料應放哪些專案或課程成果。",
      "enExample": "If you want to apply to Information Management, AI can list skills to emphasize, possible interview questions, and what projects or course outputs to include.",
      "zhPractice": "列出你想申請的 3 個科系，並請 AI 幫你整理每個科系可能重視的能力、備審方向與面試題型。",
      "enPractice": "List 3 target majors and ask AI to summarize the abilities, application material direction, and interview question types for each.",
      "zhQuiz": "第一階段通常主要看什麼？A. 面試表現 B. 學測成績與篩選條件 C. 教授喜好。答案：B。",
      "enQuiz": "What does the first stage usually focus on? A. Interview performance B. Test scores and screening criteria C. Professor preference. Answer: B.",
      "zhOutcome": "完成一份大學申請流程理解表與 7 天準備清單。",
      "enOutcome": "Complete an application process understanding table and a 7-day preparation checklist."
    },
    {
      "zhTitle": "第2課：用 AI 找出最適合自己的科系",
      "enTitle": "Lesson 2: Use AI to Find Suitable Majors",
      "zhConcept": "選科系不能只看熱門、分數或朋友選什麼。你要把興趣、能力、學習經驗、個性與未來方向一起考慮。AI 的價值是幫你提出可能方向與比較表，但你需要自己查證每個科系的課程內容與職涯發展。",
      "enConcept": "Choosing a major should not depend only on popularity, scores, or friends. You should consider interests, abilities, learning experiences, personality, and future direction. AI helps generate possible directions and comparison tables, but you must verify curriculum and career paths.",
      "zhPrompt": "我是高中三年級學生，請你擔任升學輔導老師。\n我的興趣：\n我的強項科目：\n我的弱項科目：\n我參加過的活動：\n我未來可能想做的工作：\n請推薦 5 個適合我的科系，並用表格比較：適合原因、需要能力、未來職涯、我目前缺少什麼、下一步要查什麼。",
      "enPrompt": "I am a high school senior. Act as an admissions counselor.\nMy interests:\nStrong subjects:\nWeak subjects:\nActivities:\nPossible future jobs:\nRecommend 5 suitable majors and compare them in a table: why they fit, required abilities, career paths, what I lack, and what to research next.",
      "zhExample": "興趣是心理學、擅長國文與生物、常參加服務活動的人，可以探索心理、社工、教育、護理、職能治療等方向，但仍要查課程內容。",
      "enExample": "A student interested in psychology, strong in Chinese and biology, and active in service could explore psychology, social work, education, nursing, or occupational therapy, while still checking curricula.",
      "zhPractice": "完成一份「科系探索表」，至少比較 5 個科系，並為每個科系寫下你需要進一步查證的 2 件事。",
      ...
      "enQuiz": "Which factor should not be used alone to choose a major? A. Interest B. Ability C. Popularity. Answer: C.",
      "zhOutcome": "完成科系探索表與 3 個優先申請科系清單。",
      "enOutcome": "Complete a major exploration table and a list of 3 priority majors."
    },
    {
      "zhTitle": "第3課：用 AI 整理高中三年的學習歷程素材",
      "enTitle": "Lesson 3: Use AI to Organize High School Portfolio Materials",
      "zhConcept": "很多學生不是沒有內容，而是不知道怎麼分類。學習歷程素材包含課程成果、社團活動、幹部經驗、競賽、服務、專題、作品與自主學習。你要先整理素材，再決定哪些適合放進申請資料。",
      "enConcept": "Many students do have content but do not know how to classify it. Portfolio materials include course outputs, clubs, leadership, competitions, service, projects, works, and self-directed learning. Organize materials first, then decide what fits your application.",
      "zhPrompt": "請你幫我整理高中三年的學習歷程素材。以下是我的經驗：\n（貼上所有經驗）\n請幫我分類成：課程成果、社團活動、幹部經驗、競賽成果、志工服務、自主學習、專題作品。\n每一項請整理：事件名稱、我做了什麼、學到什麼、可以展現的能力、適合申請哪些科系。",
      "enPrompt": "Help me organize my high school portfolio materials. Here are my experiences:\n(paste experiences)\nCategorize them into course outputs, clubs, leadership, competitions, service, self-directed learning, and projects.\nFor each, summarize: name, what I did, what I learned, abilities shown, and suitable majors.",
      "zhExample": "一個科展作品不只是比賽成果，也可能展現研究能力、資料整理、問題解決與簡報能力。",
      "enExample": "A science fair project is not only a competition result; it can show research, data organization, problem solving, and presentation ability.",
      "zhPractice": "建立一份素材庫，至少放入 10 個高中經驗，並用 AI 幫你分類與標註能力。",
      "enPractice": "Build a material database with at least 10 high school experiences, then use AI to classify and tag abilities.",
      "zhQuiz": "學習歷程素材整理的第一步是什麼？A. 直接寫自傳 B. 先分類與盤點素材 C. 先做封面。答案：B。",
      "enQuiz": "What is the first step in organizing portfolio materials? A. Write autobiography directly B. Classify and inventory materials C. Design cover first. Answer: B.",
      "zhOutcome": "完成高中學習歷程素材庫。",
      "enOutcome": "Complete a high school portfolio material database."
    },
    {
      "zhTitle": "第4課：用 STAR 架構寫出有說服力的多元表現",
      "enTitle": "Lesson 4: Use STAR to Write Strong Diverse Performance Descriptions",
      "zhConcept": "多元表現不是列活動名稱，而是說清楚你遇到什麼情境、負責什麼任務、採取什麼行動、最後得到什麼結果。STAR 架構能讓你的經驗變得具體、有邏輯，也比較容易在面試中說明。",
      "enConcept": "Diverse performance is not just listing activity names. You need to explain the situation, task, action, and result. STAR makes your experiences concrete, logical, and easier to explain in interviews.",
      "zhPrompt": "請使用 STAR 架構幫我整理以下活動經驗：\n活動名稱：\nSituation 情境：\nTask 任務：\nAction 行動：\nResult 結果：\n請幫我改寫成 300 字以內，適合放進大學申請備審資料的多元表現描述。語氣真誠，不要誇大，不要捏造。",
      "enPrompt": "Use the STAR structure to organize this activity:\nActivity:\nSituation:\nTask:\nAction:\nResult:\nRewrite it within 300 words as a diverse performance description for university applications. Keep it sincere and do not exaggerate or invent.",
      "zhExample": "不要只寫「我擔任班長」。要寫你面對什麼班級問題、如何協調、最後改善了什麼。",
      "enExample": "Do not only write 'I was class leader.' Explain what class problem you faced, how you coordinated, and what improved.",
      "zhPractice": "選 3 個活動經驗，各自用 STAR 架構整理，並請 AI 幫你改寫成備審可用版本。",
      "enPractice": "Choose 3 activities, organize each with STAR, and ask AI to rewrite them for application materials.",
      "zhQuiz": "STAR 的 R 代表什麼？A. Reason B. Result C. Research。答案：B。",
      "enQuiz": "What does R in STAR mean? A. Reason B. Result C. Research. Answer: B.",
      "zhOutcome": "完成 3 則多元表現描述。",
      "enOutcome": "Complete 3 diverse performance descriptions."
    },
    {
      "zhTitle": "第5課：用 AI 產出學習歷程自述初稿",
      "enTitle": "Lesson 5: Use AI to Draft a Learning Autobiography",
      "zhConcept": "學習歷程自述不是把人生全部寫完，而是把你的學習動機、重要經驗、能力成長與申請科系連起來。AI 可以協助你整理架構，但你必須保留真實經驗與自己的語氣。",
      "enConcept": "A learning autobiography is not your whole life story. It connects learning motivation, important experiences, ability growth, and target major. AI can help structure it, but your real experience and voice must remain.",
      "zhPrompt": "請你擔任大學申請寫作顧問。我要撰寫學習歷程自述。\n我的目標科系：\n我的重要學習經驗：\n我的活動經驗：\n我想強調的能力：\n我的未來目標：\n請幫我產出一份自述架構，包含：開頭、學習歷程、能力成長、申請動機、未來規劃。請不要捏造內容。",
      "enPrompt": "Act as a university application writing consultant. I need to write a learning autobiography.\nTarget major:\nImportant learning experiences:\nActivities:\nAbilities to emphasize:\nFuture goals:\nCreate a structure including opening, learning journey, ability growth, motivation, and future plan. Do not invent content.",
      "zhExample": "申請設計相關科系，可以把美術課作品、社群設計經驗、參與展覽或自主學習連成一條故事線。",
      "enExample": "For design-related majors, connect art class works, social media design, exhibitions, or self-learning into one storyline.",
      "zhPractice": "用 AI 產生自述架構後，自己補上真實細節，再請 AI 幫你檢查是否太空泛。",
      "enPractice": "Generate a structure with AI, add real details yourself, then ask AI to check if it is too vague.",
      "zhQuiz": "學習歷程自述最應該避免什麼？A. 真實反思 B. 具體例子 C. 空泛與誇大。答案：C。",
      "enQuiz": "What should a learning autobiography avoid most? A. Real reflection B. Concrete examples C. Vagueness and exaggeration. Answer: C.",
    ...
    },
    {
      ...
      "zhConcept": "同一份備審資料不能丟給所有科系。不同科系重視的能力不同，例如商管重視邏輯與溝通，資訊重視問題解決與專案，教育重視服務與表達。AI 可以幫你分析科系需求，再調整備審重點。",
      "enConcept": "One application package should not be used for every major. Different majors value different abilities. Business may value logic and communication; information fields may value problem solving and projects; education may value service and expression. AI can help analyze major needs and adjust focus.",
      "zhPrompt": "我想申請的科系是：____。\n請你分析這個科系可能重視的能力，並根據我的經驗：____，幫我建議備審資料應該放哪些內容。\n請分成：必放內容、可加分內容、不建議放的內容、需要補強的內容。",
      "enPrompt": "My target major is: ____.\nAnalyze the abilities this major may value. Based on my experiences: ____, suggest what to include in my application materials.\nDivide into must-include, bonus, not recommended, and needs improvement.",
      "zhExample": "申請心理系時，志工服務、觀察紀錄、閱讀心得與人際互動經驗可能比單純活動數量更重要。",
      "enExample": "For psychology, service, observation notes, reading reflections, and interpersonal experiences may matter more than simply listing many activities.",
      "zhPractice": "選定一個目標科系，請 AI 幫你做「科系需求 × 我的素材」對照表。",
      "enPractice": "Choose one target major and ask AI to create a 'major requirements × my materials' comparison table.",
      "zhQuiz": "備審資料為什麼要依科系調整？答案：因為不同科系重視的能力與證據不同。",
      "enQuiz": "Why should application materials be adjusted by major? Answer: different majors value different abilities and evidence.",
      "zhOutcome": "完成一份科系專屬備審資料規劃表。",
      "enOutcome": "Complete a major-specific application material plan."
    },
    {
      "zhTitle": "第7課：建立大學面試題庫與回答架構",
      "enTitle": "Lesson 7: Build an Interview Question Bank and Answer Framework",
      "zhConcept": "面試準備不是背答案，而是建立回答架構。常見題型包含自我介紹、申請動機、學習歷程、科系理解、未來規劃、時事與臨場題。AI 可以幫你產生題庫與回答方向。",
      "enConcept": "Interview preparation is not memorizing answers; it is building answer frameworks. Common question types include self-introduction, motivation, portfolio, major understanding, future plan, current issues, and situational questions. AI can generate a question bank and answer directions.",
      "zhPrompt": "請你擔任大學教授。我申請的科系是：____。\n請設計 20 題面試問題，分成：自我介紹、申請動機、學習歷程、科系理解、未來規劃、臨場反應。\n每題請提供回答架構，但不要直接替我寫完整答案。",
      "enPrompt": "Act as a university professor. My target major is: ____.\nCreate 20 interview questions divided into self-introduction, motivation, portfolio, major understanding, future plan, and situational response.\nFor each, provide an answer framework but do not write the full answer for me.",
      "zhExample": "問題：為什麼選本系？回答架構：過去經驗 → 對科系理解 → 目前準備 → 未來目標。",
      "enExample": "Question: Why this major? Framework: past experience → understanding of the major → current preparation → future goal.",
      "zhPractice": "產生 20 題後，挑出最容易卡住的 5 題，為每題寫下 3 個回答重點。",
      "enPractice": "After generating 20 questions, choose the 5 hardest ones and write 3 key points for each.",
      "zhQuiz": "面試準備最不建議做什麼？A. 建立架構 B. 練習表達 C. 背誦 AI 產生的完整答案。答案：C。",
      "enQuiz": "What is not recommended for interviews? A. Build frameworks B. Practice expression C. Memorize AI-generated full answers. Answer: C.",
      "zhOutcome": "完成個人面試題庫與回答架構。",
      "enOutcome": "Complete a personal interview question bank and answer framework."
    },
    {
      "zhTitle": "第8課：用 AI 進行模擬面試與回饋修正",
      "enTitle": "Lesson 8: Use AI for Mock Interviews and Feedback",
      "zhConcept": "模擬面試的目的不是得到標準答案，而是練習臨場表達。AI 可以扮演教授，一次問一題，並從清楚度、具體性、邏輯與說服力給你回饋。",
      "enConcept": "The goal of mock interviews is not to get standard answers, but to practice real-time expression. AI can act as a professor, ask one question at a time, and provide feedback on clarity, specificity, logic, and persuasiveness.",
      "zhPrompt": "請你擔任大學教授，針對我申請的科系：____，進行模擬面試。\n規則：\n1. 一次只問一題\n2. 等我回答後再問下一題\n3. 每次回答後請用清楚度、具體性、邏輯、說服力四項評分\n4. 請給我具體改進建議",
      "enPrompt": "Act as a university professor and conduct a mock interview for my target major: ____.\nRules:\n1. Ask only one question at a time\n2. Wait for my answer before asking the next\n3. Rate clarity, specificity, logic, and persuasiveness after each answer\n4. Give specific improvement suggestions",
      "zhExample": "AI 評語可能指出：回答太抽象、缺少具體例子、沒有連結科系、結尾沒有未來方向。",
      "enExample": "AI feedback may point out that the answer is too abstract, lacks examples, does not connect to the major, or lacks future direction.",
      "zhPractice": "完成至少 5 題模擬面試，將 AI 的建議整理成「我的面試改進清單」。",
      "enPractice": "Complete at least 5 mock interview questions and organize AI feedback into 'My Interview Improvement Checklist'.",
      "zhQuiz": "模擬面試最重要的是什麼？答案：根據回饋修正回答並反覆練習。",
      "enQuiz": "What matters most in mock interviews? Answer: revise based on feedback and practice repeatedly.",
    ...
    },
    {
      ...
      "zhConcept": "每次問 AI 都重新說明背景很浪費時間。你可以建立一段固定的個人背景 Prompt，讓 AI 長期扮演你的升學顧問，回答問題時都根據你的目標科系、經驗與申請狀態。",
      "enConcept": "Repeating your background to AI every time wastes time. You can create a reusable background prompt so AI acts as your admissions advisor based on your target majors, experiences, and application status.",
      "zhPrompt": "你是我的專屬升學顧問。請記住以下背景，之後回答都要根據這些資訊：\n我的年級：高中三年級\n目標科系：\n我的優勢：\n我的弱點：\n重要學習歷程：\n目前申請進度：\n請先幫我確認資料是否完整，並問我 5 個需要補充的問題。",
      "enPrompt": "You are my personal admissions advisor. Remember the following background and answer based on it:\nGrade: high school senior\nTarget majors:\nStrengths:\nWeaknesses:\nImportant portfolio experiences:\nCurrent application progress:\nFirst check whether the information is complete and ask me 5 questions to fill gaps.",
      "zhExample": "你可以把這段 Prompt 放在 ChatGPT 的自訂指令，或存在筆記裡，每次準備備審或面試時貼上使用。",
      "enExample": "You can put this prompt into ChatGPT custom instructions or save it in notes and reuse it when preparing materials or interviews.",
      "zhPractice": "建立你的個人升學顧問 Prompt，並用它詢問：我目前最需要補強哪三件事？",
      "enPractice": "Create your personal admissions advisor prompt and ask: What are the three things I need to improve most right now?",
      "zhQuiz": "個人 AI 升學顧問最重要的輸入是什麼？答案：你的真實背景、目標科系與目前進度。",
      "enQuiz": "What is the most important input for a personal AI admissions advisor? Answer: your real background, target majors, and current progress.",
    ...
    },
    {
      ...
      "zhConcept": "最後一課要把前面所有成果整合成可以實際使用的申請包。你的申請包應該呈現一個清楚故事：我想申請什麼、我為什麼適合、我有哪些證據、我未來想怎麼學習。",
      "enConcept": "The final lesson integrates all outputs into a usable application package. Your package should tell a clear story: what you want to apply for, why you fit, what evidence you have, and how you want to learn in the future.",
      "zhPrompt": "請你擔任大學申請總顧問。請根據我完成的資料幫我檢查申請包是否完整：\n1. 科系探索表\n2. 學習歷程素材庫\n3. 多元表現描述\n4. 學習歷程自述\n5. 科系專屬備審規劃\n6. 面試題庫\n7. 模擬面試紀錄\n8. 個人 AI 升學顧問 Prompt\n請用表格列出：已完成、需要修改、缺少資料、下一步。",
      "enPrompt": "Act as my final university application consultant. Review whether my application package is complete:\n1. Major exploration table\n2. Portfolio material database\n3. Diverse performance descriptions\n4. Learning autobiography\n5. Major-specific application plan\n6. Interview question bank\n7. Mock interview records\n8. Personal AI admissions advisor prompt\nUse a table: completed, needs revision, missing data, next step.",
      "zhExample": "最後檢查時，你可能會發現自述有內容，但沒有連結科系；面試題庫有題目，但回答缺少具體例子。",
      "enExample": "During final review, you may find your autobiography has content but does not connect to the major, or your interview answers lack concrete examples.",
      "zhPractice": "建立一個資料夾「我的大學申請包」，放入本課程所有成果，並請 AI 做最後總檢查。",
      "enPractice": "Create a folder called 'My University Application Package', put all course outputs into it, and ask AI for a final review.",
      "zhQuiz": "完整申請包最重要的是什麼？答案：所有資料要共同支持你的申請主軸。",
      "enQuiz": "What matters most in a complete application package? Answer: all materials should support your application theme.",
      "zhOutcome": "完成完整大學申請包。",
