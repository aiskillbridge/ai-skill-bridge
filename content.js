...
const I18N = {
  zh: {
    ...
    home: {
      ...
      title: "真正學會 AI，而不是只會問 ChatGPT。",
      lead: "從 AI 基礎、Prompt、工作流程到實戰作品，AI Skill Bridge 幫你建立真正用得上的 AI 能力。",
      trust: "★★★★★ 受到學生、上班族與創作者信任",
      start: "免費開始體驗",
      explore: "查看完整課程",
      dashProgress: "Learning Progress",
      dashProjects: "Projects",
      dashPrompts: "AI Tools",
      ...
      buildLead: "無論你是學生、上班族、創作者、自由工作者或企業內訓學員，都能把 AI 技能變成可用、可分享、可展示的真實成果。",
      build1: "AI Resume",
      build1Desc: "用 AI 協助結構化，打造針對職位優化的履歷。",
      build2: "AI Presentation",
      build2Desc: "簡報大綱、講稿與視覺敘事流程。",
      build3: "AI Website",
      build3Desc: "Landing Page 與作品集網站。",
      build4: "Automation",
      ...
      pathLead: "從第一個 Prompt 到職場作品與作品集 — 適合各階段學習者的清晰路徑。",
      path1: "Learn",
      path1Desc: "核心概念與工具",
      path2: "Practice",
      path2Desc: "互動式練習",
      ...
      featLead: "為學生、上班族、創作者、自由工作者與企業內訓而設 — 從好奇到真正上手。",
      ...
      testLead: "來自學生、上班族、創作者與自由工作者的回饋。",
      test1: "「終於有人把 AI 講清楚，不是只丟工具名稱。」",
      test1Role: "Product Designer · 上班族",
      test2: "「互動練習讓我真正學會 Prompt，不是只看影片。」",
      test2Role: "Marketing Manager · 企業內訓",
      test3: "「做完專案後，我直接把成果放進作品集。」",
      test3Role: "Freelancer · 自由工作者",
      priceTitle: "Simple, Transparent Pricing",
      priceLead: "先免費體驗，準備好再升級完整課程。",
      priceFree: "Free",
      priceFreeDesc: "適合想從零開始建立 AI 能力的學習者。",
      priceFree1: "免費入門課程",
      priceFree2: "互動測驗",
      priceFree3: "AI 工具導航",
      ...
      faqLead: "開始之前，你可能想知道的事。",
      faq1Q: "需要 AI 基礎嗎？",
      faq1A: "不需要。免費路徑從零開始 — 什麼是 AI、Prompt 怎麼寫、第一個實用流程。",
      faq2Q: "Premium 是訂閱制嗎？",
      faq2A: "不是。Premium 為一次性購買，解鎖後終身存取。",
      faq3Q: "可以先試再付費嗎？",
      faq3A: "可以。先完成免費課程，再決定是否升級進階專案與模板。",
      faq4Q: "適合誰使用？",
      faq4A: "學生、上班族、創作者、自由工作者、企業內訓團隊 — 任何想建立實用 AI 能力的人。",
      faq5Q: "有雙語內容嗎？",
      faq5A: "有。可隨時在頁首切換中文與 English。",
      ...
      ctaTitle: "今天就開始建立真正的 AI 能力",
      ctaLead: "加入正在用互動專案練出實戰技能的學習者 — 從學生到上班族、創作者與企業團隊。",
      ctaStart: "免費開始體驗",
      ctaExplore: "查看完整課程"
    },
    courses: {
  ...
  en: {
    ...
    home: {
      ...
      badge: "✨ AI Learning Platform",
      title: "Master AI for real — not just ChatGPT prompts.",
      lead: "From AI fundamentals, prompts, and workflows to portfolio projects — AI Skill Bridge builds skills you can actually use.",
      trust: "★★★★★ Trusted by students, professionals, and creators",
      ...
      buildTitle: "What You Can Build",
      buildLead: "Whether you're a student, professional, creator, freelancer, or corporate learner — turn AI skills into real deliverables.",
      build1: "AI Resume",
      ...
      pathTitle: "Learning Path",
      pathLead: "From your first prompt to career-ready projects — a clear path for every stage.",
      path1: "Learn",
      ...
      featTitle: "Built for Real Learning",
      featLead: "Built for students, professionals, creators, freelancers, and corporate teams.",
      feat1: "Interactive Lessons",
      ...
      stat4Label: "AI Support",
      testTitle: "Loved by Learners",
      testLead: "Feedback from learners across different backgrounds.",
      test1: "\"Finally someone explains AI clearly — not just a list of tool names.\"",
      test1Role: "Product Designer · Professional",
      test2: "\"Interactive practice helped me actually learn prompts, not just watch videos.\"",
      test2Role: "Marketing Manager · Corporate Training",
      test3: "\"After the project track, I added real work straight to my portfolio.\"",
      test3Role: "Freelancer",
      priceTitle: "Simple, Transparent Pricing",
      priceLead: "Try free first. Upgrade when you're ready for the full curriculum.",
      priceFree: "Free",
      priceFreeDesc: "Perfect for building AI skills from zero.",
      ...
      priceLaunch: "Launch Offer",
      priceOffer: "Limited Offer",
      priceSoon: "Coming Soon",
      priceSoonDesc: "Team plans and enterprise features.",
      priceSoon1: "Team workspace",
      priceSoon2: "Admin dashboard",
      priceSoon3: "Custom learning paths",
      priceCtaFree: "Start Free Trial",
      priceCtaPremium: "Get Premium",
      priceCtaSoon: "Notify Me",
      faqTitle: "Frequently Asked Questions",
      faqLead: "Everything you need to know before you start.",
      ...
      faq2A: "No. Premium is a one-time purchase with lifetime access to the courses you unlock.",
      faq3Q: "Can I try before I pay?",
      faq3A: "Yes. Complete the free lessons first, then upgrade when you want advanced projects and templates.",
      faq4Q: "Who is AI Skill Bridge for?",
      faq4A: "Students, professionals, creators, freelancers, and corporate teams — anyone who wants practical AI skills.",
      faq5Q: "Is content bilingual?",
      faq5A: "Yes. Switch between 中文 and English anytime from the header.",
      footerTagline: "The easiest way to master AI.",
      footerProduct: "Product",
      footerLearn: "Learn",
      footerCompany: "Company",
      ...
      footerTerms: "Terms",
      footerCopy: "© 2026 AI Skill Bridge. All rights reserved.",
      ctaTitle: "Start building real AI skills today",
      ctaLead: "Join learners turning interactive projects into practical skills — from students to teams.",
      ctaStart: "Start Free Trial",
      ctaExplore: "View Full Courses"
    },
    courses: {
