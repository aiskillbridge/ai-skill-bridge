    ...
    "quizItems": [
      {
        ...
        "answer": 1,
        "explain": "AI 可以協助整理與產出，但最後判斷仍然要由人完成。"
      },
      {
        "q": "同一個問題請 AI 用不同對象解釋，主要目的為何？",
        "options": [
          "測試 AI 會不會生氣",
          "讓說明更符合聽眾程度",
          "讓答案變得更長"
        ...
        "answer": 1,
        "explain": "指定對象能讓 AI 調整語氣、深度與例子。"
      },
      {
        "q": "使用 AI 時最重要的能力之一是什麼？",
        "options": [
          "把需求說清楚",
          "完全不檢查答案",
          "只問一句話"
    ...
    "quizItems": [
      {
        ...
        "options": [
          "幫我寫報告",
          "請擔任高中報告教練，幫我規劃環保主題 5 分鐘簡報，列出開場、三個重點與結論",
          "快點"
        ],
        "answer": 1,
        "explain": "好的 Prompt 會包含角色、任務、背景、格式與限制。"
      },
      {
        "q": "好的 Prompt 通常不包含哪一項？",
        "options": [
          "角色",
          "輸出格式",
          "完全不提供背景"
