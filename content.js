...
const I18N = {
  zh: {
    ...
    home: {
      badge: "🔥 超過 1000 位學習者",
      title: "人人都能學會 AI，<br>從日常工作到專業實戰。",
      lead: "AI Skill Bridge 提供完整 AI 學習路徑，無論你是學生、上班族、老師、創作者或企業，都能透過 AI 提升效率、建立作品集、打造第二技能。",
      start: "立即免費開始",
      premium: "查看所有課程",
      previewTitle: "AI Learning Roadmap",
      previewSubtitle: "你的 AI 學習路徑",
      roadmap1: "AI 基礎操作",
      roadmap2: "Prompt Engineering",
      roadmap3: "AI 工作流程",
      roadmap4: "AI 自動化",
      roadmap5: "AI 專案作品集",
      packageTitle: "完整 AI Skill Bridge",
      packageDesc: "10 堂完整課程",
      packagePrice: "NT$1,990",
      packageCta: "立即開始學習",
      outcomesTitle: "你可以完成的 AI 成果",
      outcomesLead: "從基礎操作到專案作品集，每個階段都有具體可交付的成果，不只是零散的 AI 技巧。",
      outcome1: "AI 基礎操作",
      ...
      feature3: "分級進階路徑",
      feature3Desc: "含學習、研究、求職、職場、創業與自動化等 6 套實戰課程。",
      feature4: "AI 教練回饋",
  ...
  en: {
    ...
    home: {
      badge: "🔥 1,000+ learners",
      title: "Everyone Can Learn AI,<br>From Daily Work to Professional Practice.",
      lead: "AI Skill Bridge offers a complete AI learning path. Whether you're a student, professional, teacher, creator, or business — use AI to boost efficiency, build a portfolio, and develop a second skill.",
      start: "Start Free Now",
      premium: "View All Courses",
      previewTitle: "AI Learning Roadmap",
      previewSubtitle: "Your AI Learning Path",
      roadmap1: "AI Basics",
      roadmap2: "Prompt Engineering",
      roadmap3: "AI Workflows",
      roadmap4: "AI Automation",
      roadmap5: "AI Project Portfolio",
      packageTitle: "Complete AI Skill Bridge",
      packageDesc: "10 Full Lessons",
      packagePrice: "NT$1,990",
      packageCta: "Start Learning Now",
      outcomesTitle: "AI Outcomes You Can Complete",
      outcomesLead: "From basics to project portfolios — concrete deliverables at every stage, not just scattered AI tips.",
      outcome1: "AI Basics",
      outcome1Desc: "Start from zero: learn core AI tools and how to ask useful questions for daily tasks.",
      outcome2: "Prompt Engineering",
      outcome2Desc: "Master role, format, and constraints so AI gives sharper, more useful answers.",
      ...
      outcome4Desc: "Learn to chain tasks with AI, save time, and prepare for advanced applications.",
      outcome5: "AI Project Portfolio",
      outcome5Desc: "Finish showcase-ready AI projects as proof of learning or career portfolio pieces.",
      ...
      feature3Desc: "Six tracks covering learning, research, career, workplace, startup, and automation.",
