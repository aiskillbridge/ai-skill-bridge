...
const I18N = {
  zh: {
    ...
    home: {
      ...
      title: "Master AI.<br>Build Your Future.",
      lead: "透過 ChatGPT、Claude、Gemini、Cursor 與現代 AI 工作流程，以互動專案與實戰練習真正學會 AI。",
      trust: "★★★★★ 受到 AI 學習者信任",
      start: "免費開始",
      explore: "探索課程",
      ...
      faq4Q: "適合誰使用？",
      faq4A: "學生、上班族、創作者、自由工作者、創業者 — 任何想學實用 AI 技能的人。",
      faq5Q: "有雙語內容嗎？",
  ...
  en: {
    ...
    home: {
      ...
      badge: "✨ AI Learning Platform",
      title: "Master AI.<br>Build Your Future.",
      lead: "Learn ChatGPT, Claude, Gemini, Cursor and modern AI workflows through interactive projects and real-world practice.",
