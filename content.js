...
const I18N = {
  zh: {
    ...
    home: {
      eyebrow: "雙語 AI 互動學習平台",
      title: "零基礎也能學會 AI，從日常任務到進階實戰。",
      lead: "AI Skill Bridge 提供免費入門課程與 6 套分級實戰課程。每套 10 堂課、Prompt 模板與可交付成果，讓你真正學會用 AI 解決問題。",
      start: "免費開始學習",
      tools: "探索 AI 工具",
      premium: "查看付費課程",
      premiumCta: "解鎖進階課程",
      progress: "你的學習進度",
      missionTitle: "為什麼選擇 AI Skill Bridge？",
      missionText: "不是教你背 Prompt，而是建立可重複使用的 AI 工作流程。",
      freeTitle: "免費入門",
      ...
      premiumTracks: "付費路徑",
      languages: "語言",
      heroBadge: "🎓 已服務 1,000+ 學習者",
      heroSub: "從 NT$499 起 · 一次購買終身存取 · 雙語互動教學",
      statLearners: "學習者",
      statLessons: "互動課程",
      statCourses: "實戰路徑",
      statTools: "AI 工具",
      featuresTitle: "一套完整的 AI 學習系統",
      featuresLead: "從能力測驗到實戰課程，每個環節都為「真正學會」而設計。",
      feature1Title: "能力測驗",
      feature1Text: "3 分鐘測驗判斷你的 AI 等級，推薦最適合的學習起點。",
      feature2Title: "互動實作",
      feature2Text: "每課含 Prompt 練習、互動測驗與可交付成果，不是只看影片。",
      feature3Title: "分級路徑",
      feature3Text: "從高中申請到大學學習、研究競賽、求職、職場到創業，依需求選課。",
      feature4Title: "工具導航",
      feature4Text: "依任務推薦最適合的 AI 工具，不再迷失在數百個 App 之間。",
      stepsTitle: "三步開始你的 AI 成長",
      step1Title: "免費測驗",
      step1Text: "了解你的起點，獲得個人化學習建議。",
      step2Title: "免費入門",
      step2Text: "完成基礎課程，建立 Prompt 思維與 AI 使用習慣。",
      step3Title: "解鎖實戰",
      step3Text: "選擇符合目標的進階課程，產出可交付的完整成果。",
      coursesTitle: "選擇你的 AI 實戰路徑",
      coursesLead: "每套課程 10 堂課 + Prompt 模板 + 最終成果，一次購買終身存取。",
      allAccessTitle: "全站通行證",
      allAccessDesc: "一次解鎖全部 6 套課程 · 60 堂課 · 未來更新",
      allAccessCta: "查看全站方案",
      compareTitle: "免費 vs 進階",
      compareFree: "免費入門",
      comparePremium: "進階實戰",
      compareRow1: "AI 基礎概念與 Prompt 入門",
      compareRow2: "互動測驗與練習",
      compareRow3: "10 堂完整實戰課程",
      compareRow4: "Prompt 模板與工作流程",
      compareRow5: "可交付成果（申請包、作品集等）",
      compareRow6: "學習進度同步與筆記",
      testimonialsTitle: "學習者怎麼說",
      testimonial1: "「終於有人用白話解釋 Prompt，不是只丟一堆術語。」",
      testimonial1Role: "大學生 · 免費課程",
      testimonial2: "「申請課幫我把高中經驗整理成有邏輯的故事，面試前反覆練習很有用。」",
      testimonial2Role: "高中生 · 申請大學課",
      testimonial3: "「職場效率課的 Email 與會議紀錄流程，我現在每天都在用。」",
      testimonial3Role: "上班族 · 職場效率課",
      faqTitle: "常見問題",
      faq1Q: "我完全沒用過 AI，可以開始嗎？",
      faq1A: "可以。免費入門課程從「什麼是 AI」開始，不需要任何背景。",
      faq2Q: "付費課程是一次性還是訂閱？",
      faq2A: "一次性購買，終身存取。每套課程包含 10 堂課與所有模板。",
      faq3Q: "可以先試免費課程再決定嗎？",
      faq3A: "當然。建議先完成免費入門與能力測驗，確認適合後再解鎖進階課程。",
      faq4Q: "全站通行證值得買嗎？",
      faq4A: "若你計畫走完整 AI 成長路徑，全站方案比單買 6 套課程更划算。",
      ctaTitle: "準備好把 AI 變成你的超能力了嗎？",
      ctaLead: "從免費入門開始，或立即解鎖符合你目標的實戰課程。",
      ctaPrimary: "查看付費課程",
      ctaSecondary: "免費開始學習",
      perCourse: "每套課程",
      lessonsCount: "10 堂課",
  ...
  en: {
    ...
    home: {
      eyebrow: "Bilingual AI Learning Platform",
      title: "Learn AI from zero to real-world mastery.",
      lead: "AI Skill Bridge offers free beginner courses and 6 advanced tracks. Each track includes 10 lessons, prompt templates, and deliverable outcomes so you actually learn to solve problems with AI.",
      start: "Start Free",
      tools: "Explore AI Tools",
      premium: "View Premium Courses",
      premiumCta: "Unlock Premium",
      progress: "Your Learning Progress",
      missionTitle: "Why AI Skill Bridge?",
      missionText: "We don't teach you to memorize prompts. We help you build reusable AI workflows.",
      ...
      languages: "Languages",
      heroBadge: "🎓 Trusted by 1,000+ learners",
      heroSub: "From NT$499 · Lifetime access · Bilingual interactive lessons",
      statLearners: "Learners",
      statLessons: "Interactive Lessons",
      statCourses: "Premium Tracks",
      statTools: "AI Tools",
      featuresTitle: "A Complete AI Learning System",
      featuresLead: "From skill assessment to hands-on courses, every step is designed for real learning.",
      feature1Title: "Skill Assessment",
      feature1Text: "A 3-minute quiz identifies your AI level and recommends the best starting point.",
      feature2Title: "Interactive Practice",
      feature2Text: "Every lesson includes prompt exercises, quizzes, and deliverables — not just videos.",
      feature3Title: "Leveled Paths",
      feature3Text: "From university applications to research, career, workplace, and startup — pick what fits your goal.",
      feature4Title: "Tool Navigator",
      feature4Text: "Get the right AI tool for each task instead of getting lost among hundreds of apps.",
      stepsTitle: "Three Steps to AI Growth",
      step1Title: "Free Assessment",
      step1Text: "Know your starting point and get personalized recommendations.",
      step2Title: "Free Beginner Track",
      step2Text: "Build prompt thinking and AI habits with foundational lessons.",
      step3Title: "Unlock Advanced",
      step3Text: "Choose the track that matches your goal and produce complete deliverables.",
      coursesTitle: "Choose Your AI Track",
      coursesLead: "Each course: 10 lessons + prompt templates + final deliverable. Buy once, access forever.",
      allAccessTitle: "All-Access Pass",
      allAccessDesc: "Unlock all 6 tracks · 60 lessons · future updates",
      allAccessCta: "View All-Access Plan",
      compareTitle: "Free vs Premium",
      compareFree: "Free Beginner",
      comparePremium: "Premium Advanced",
      compareRow1: "AI basics and prompt fundamentals",
      compareRow2: "Interactive quizzes and practice",
      compareRow3: "10 full hands-on lessons per track",
      compareRow4: "Prompt templates and workflows",
      compareRow5: "Deliverables (application packages, portfolios, etc.)",
      compareRow6: "Progress sync and notes",
      testimonialsTitle: "What Learners Say",
      testimonial1: "\"Finally someone explains prompts in plain language, not just jargon.\"",
      testimonial1Role: "University student · Free course",
      testimonial2: "\"The admissions course helped me turn high school experience into a logical story. Interview practice was invaluable.\"",
      testimonial2Role: "High school student · Admissions course",
      testimonial3: "\"The workplace productivity email and meeting notes workflow — I use it every day now.\"",
      testimonial3Role: "Professional · Workplace course",
      faqTitle: "FAQ",
      faq1Q: "I've never used AI. Can I start?",
      faq1A: "Yes. The free beginner track starts from \"What is AI?\" — no background required.",
      faq2Q: "Is premium a subscription or one-time?",
      faq2A: "One-time purchase with lifetime access. Each track includes 10 lessons and all templates.",
      faq3Q: "Can I try free courses first?",
      faq3A: "Absolutely. Complete the free track and assessment before unlocking premium.",
      faq4Q: "Is the All-Access Pass worth it?",
      faq4A: "If you plan the full AI growth path, All-Access is more cost-effective than buying all 6 tracks separately.",
      ctaTitle: "Ready to make AI your superpower?",
      ctaLead: "Start with the free track, or unlock the advanced course that fits your goal.",
      ctaPrimary: "View Premium Courses",
      ctaSecondary: "Start Free",
      perCourse: "per course",
      lessonsCount: "10 lessons",
      viewCourse: "Learn More"
    },
    courses: {
