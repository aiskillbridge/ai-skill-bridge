...
const PREMIUM = [
  {
    ...
    zhLessons: [
      "第1課：認識大學申請流程與 AI 的角色",
      "第2課：用 AI 找出最適合自己的科系",
      "第3課：用 AI 整理高中三年的學習歷程素材",
      "第4課：用 STAR 架構寫出有說服力的多元表現",
      "第5課：用 AI 產出學習歷程自述初稿",
      "第6課：針對目標科系製作專屬備審資料",
      "第7課：建立大學面試題庫與回答架構",
      "第8課：用 AI 進行模擬面試與回饋修正",
      "第9課：建立你的個人 AI 升學顧問",
      "第10課：完成完整大學申請包"
    ],
    enLessons: [
      "Lesson 1: 認識大學申請流程與 AI 的角色",
      "Lesson 2: 用 AI 找出最適合自己的科系",
      "Lesson 3: 用 AI 整理高中三年的學習歷程素材",
      "Lesson 4: 用 STAR 架構寫出有說服力的多元表現",
      "Lesson 5: 用 AI 產出學習歷程自述初稿",
      "Lesson 6: 針對目標科系製作專屬備審資料",
      "Lesson 7: 建立大學面試題庫與回答架構",
      "Lesson 8: 用 AI 進行模擬面試與回饋修正",
      "Lesson 9: 建立你的個人 AI 升學顧問",
      "Lesson 10: 完成完整大學申請包"
    ],
    zhValue: [
      "不再不知道備審要寫什麼",
  ...
  },
  {
    ...
    zhOutcome: "完成後你會建立自己的 AI 學習系統：涵蓋學習工作區、Prompt、教材整理、筆記、報告、簡報、考試與英文閱讀。",
    ...
    enLessons: [
      ...
      "Lesson 3: Intro to Prompt Engineering",
      "Lesson 4: NotebookLM Course-Material Research",
      "Lesson 5: AI Class Notes",
      "Lesson 6: PDF Key-Point Condensing",
      "Lesson 7: Build a Report Outline with AI",
      "Lesson 8: Plan a Presentation Structure with AI",
      "Lesson 9: Map Exam Scope and Must-Know Priorities",
      "Lesson 10: AI English Reading and Comprehension"
    ],
    zhValue: [
      "用系統取代零散工具收藏",
      "每堂課都有可重用模板與完成檢查",
  ...
  },
  {
    ...
    zhOutcome: "完成後你會具備 AI 研究能力：文獻搜尋、查證、APA 引用、專題協作、研究簡報與口頭報告。",
    ...
    zhLessons: [
      "第1課：Google Scholar 文獻搜尋",
      "第2課：Perplexity 深度搜尋",
      "第3課：驗證 AI 資訊真偽",
      "第4課：AI 文獻整理與引用（APA 第七版）",
      "第5課：AI 心智圖整理",
      "第6課：AI 團隊分工與角色配置",
      "第7課：AI 專案規劃與風險管理",
      "第8課：AI 小組報告與成果整合",
    ...
    enLessons: [
      "Lesson 1: Google Scholar Literature Search",
      "Lesson 2: Deep Search with Perplexity",
      "Lesson 3: Verify AI Information Authenticity",
      "Lesson 4: Literature Notes and APA 7th Citations",
      "Lesson 5: AI Mind-Map Organization",
      "Lesson 6: AI Team Roles and Responsibility Design",
      "Lesson 7: AI Project Planning and Risk Management",
      "Lesson 8: AI Team Deliverable Integration",
      "Lesson 9: Build Slides with Gamma AI",
      "Lesson 10: AI Mock Q&A and Presentation Skills"
    ],
    zhValue: [
      "讓專題與競賽不再只靠靈感",
      "資料整理更快且更有條理",
  ...
  },
  {
    ...
    zhOutcome: "完成後你會完成一份求職包：經驗盤點、履歷、自我介紹、LinkedIn、面試、Cover Letter 與作品集。",
    ...
    zhLessons: [
      ...
      "第8課：用 AI 盤點個人經驗與能力",
      "第9課：用 STAR 法則整理經驗",
      "第10課：用 AI 撰寫求職信與 Cover Letter"
    ],
    enLessons: [
      "Lesson 1: AI Resume Writing and Optimization",
      "Lesson 2: AI Self-Introduction and Personal Narrative",
      "Lesson 3: AI LinkedIn Personal Branding",
      "Lesson 4: AI Interview Simulation and Answering Skills",
      "Lesson 5: AI Job Search Strategy and Career Planning",
      "Lesson 6: Personal Website and Project Showcase",
      "Lesson 7: Portfolio Curation and Final Presentation",
      "Lesson 8: Use AI to map personal experience and strengths",
      "Lesson 9: Organize experience with the STAR method",
      "Lesson 10: Use AI to write cover letters and application emails"
    ],
    zhValue: [
      "履歷不再只是流水帳",
      "面試前有明確練習方式",
  ...
  },
  {
    ...
    zhOutcome: "完成後你會建立 AI 工作能力：Email、Office、知識庫、會議、任務管理與 SOP 工作流程。",
    ...
    zhLessons: [
      "第1課：建立 AI Second Brain",
      "第2課：AI Word 與文件整理",
      "第3課：AI Excel 與資料處理",
      "第4課：AI PowerPoint 與投影片製作",
      "第5課：AI Google Workspace 協作",
      "第6課：AI Email 與學術溝通",
      "第7課：AI 會議紀錄與重點整理",
      "第8課：AI 任務管理與進度追蹤",
      "第9課：建立個人 AI 知識管理系統",
      "第10課：用 AI 建立 SOP 與流程文件"
    ],
    enLessons: [
      "Lesson 1: Build an AI Second Brain",
      "Lesson 2: AI Word and Document Organization",
      "Lesson 3: AI Excel and Data Handling",
      "Lesson 4: AI PowerPoint and Slide Production",
      "Lesson 5: AI Google Workspace Collaboration",
      "Lesson 6: AI Email and Academic Communication",
      "Lesson 7: AI Meeting Notes and Decision Capture",
      "Lesson 8: AI Task Management and Progress Tracking",
      "Lesson 9: Build Your Personal AI Knowledge System",
      "Lesson 10: Use AI to create SOPs and process documents"
    ],
    zhValue: [
      "減少重複行政工作",
      "把工作任務變成標準流程",
  ...
  },
  {
    ...
    zhOutcome: "完成後你會具備 AI 創業能力：問題定義、MVP、GitHub、Pitch Deck、自動化與 AI Agent 概念。",
    ...
    zhLessons: [
      ...
      "第4課：用 AI 建立商業模式草稿",
      "第5課：AI 專案規劃與 MVP 設計",
      "第6課：用 AI 建立 Pitch Deck 架構",
      "第7課：GitHub 專案管理與版本紀錄",
      "第8課：AI 自動化思維與流程拆解",
      "第9課：Zapier、Make、n8n 與 AI Agent 概念",
      "第10課：完成創業提案與 AI 自動化流程"
    ],
    enLessons: [
      "Lesson 1: Use AI for problem definition",
      "Lesson 2: Use AI to analyze target users and pain points",
      "Lesson 3: Project ideation and requirements definition",
      "Lesson 4: Use AI to draft a business model",
      "Lesson 5: Project planning and MVP design",
      "Lesson 6: Use AI to build pitch deck structure",
      "Lesson 7: GitHub project management and version history",
      "Lesson 8: AI automation mindset and workflow breakdown",
      "Lesson 9: Zapier, Make, n8n, and AI Agent concepts",
...
const PREMIUM_LESSON_DETAILS = {
  ...
  "college-learning": [
    ...
    },
    {
      ...
      "chapterZh": "建立 AI 學習系統",
      "chapterEn": "Build Your AI Learning System",
      "zhTitle": "第3課：Prompt Engineering 入門",
      "enTitle": "Lesson 3: Intro to Prompt Engineering",
    ...
    },
    {
      ...
      "zhTitle": "第4課：NotebookLM 教材研究",
      "enTitle": "Lesson 4: NotebookLM Course-Material Research",
    ...
    },
    {
      ...
      "zhTitle": "第5課：AI 課堂筆記",
      "enTitle": "Lesson 5: AI Class Notes",
    ...
    },
    {
      ...
      "chapterZh": "AI 做筆記",
      "chapterEn": "AI Note-Taking",
      "zhTitle": "第6課：PDF 重點整理",
      "enTitle": "Lesson 6: PDF Key-Point Condensing",
    ...
    },
    {
      ...
      "zhTitle": "第7課：利用 AI 建立報告大綱",
      "enTitle": "Lesson 7: Build a Report Outline with AI",
    ...
    },
    {
      ...
      "zhTitle": "第8課：AI 如何規劃簡報架構",
      "enTitle": "Lesson 8: Plan a Presentation Structure with AI",
    ...
    },
    {
      ...
      "zhTitle": "第9課：AI 整理考試範圍與必考重點",
      "enTitle": "Lesson 9: Map Exam Scope and Must-Know Priorities",
    ...
    },
    {
      ...
      "zhTitle": "第10課：AI 英文閱讀與文章理解",
      "enTitle": "Lesson 10: AI English Reading and Comprehension",
  ...
  "research-competition": [
    {
      ...
      "chapterZh": "AI 資料搜尋與研究",
      "chapterEn": "AI Source Search and Research",
      "zhTitle": "第1課：Google Scholar 文獻搜尋",
      "enTitle": "Lesson 1: Google Scholar Literature Search",
    ...
    },
    {
      ...
      "chapterZh": "AI 資料搜尋與研究",
      "chapterEn": "AI Source Search and Research",
      "zhTitle": "第2課：Perplexity 深度搜尋",
      "enTitle": "Lesson 2: Deep Search with Perplexity",
    ...
    },
    {
      ...
      "chapterZh": "AI 資料搜尋與研究",
      "chapterEn": "AI Source Search and Research",
      "zhTitle": "第3課：驗證 AI 資訊真偽",
      "enTitle": "Lesson 3: Verify AI Information Authenticity",
    ...
    },
    {
      ...
      "chapterZh": "AI 寫報告",
      "chapterEn": "AI for Reports",
      "zhTitle": "第4課：AI 文獻整理與引用（APA 第七版）",
      "enTitle": "Lesson 4: Literature Notes and APA 7th Citations",
    ...
    },
    {
      ...
      "chapterZh": "AI 做筆記",
      "chapterEn": "AI Note-Taking",
      "zhTitle": "第5課：AI 心智圖整理",
      "enTitle": "Lesson 5: AI Mind-Map Organization",
    ...
    },
    {
      ...
      "zhTitle": "第6課：AI 團隊分工與角色配置",
      "enTitle": "Lesson 6: AI Team Roles and Responsibility Design",
    ...
    },
    {
      ...
      "chapterZh": "AI 團隊協作與專案管理",
      "chapterEn": "AI Team Collaboration and Project Management",
      "zhTitle": "第7課：AI 專案規劃與風險管理",
      "enTitle": "Lesson 7: AI Project Planning and Risk Management",
    ...
    },
    {
      ...
      "chapterZh": "AI 團隊協作與專案管理",
      "chapterEn": "AI Team Collaboration and Project Management",
      "zhTitle": "第8課：AI 小組報告與成果整合",
      "enTitle": "Lesson 8: AI Team Deliverable Integration",
    ...
    },
    {
      ...
      "chapterZh": "AI 做簡報",
      "chapterEn": "AI Presentations",
      "zhTitle": "第9課：Gamma AI 製作簡報",
      "enTitle": "Lesson 9: Build Slides with Gamma AI",
    ...
    },
    {
      ...
      "chapterZh": "AI 做簡報",
      "chapterEn": "AI Presentations",
      "zhTitle": "第10課：AI 模擬口頭報告與簡報技巧",
      "enTitle": "Lesson 10: AI Mock Q&A and Presentation Skills",
  ...
  "career-internship": [
    {
      ...
      "zhTitle": "第1課：AI 履歷撰寫與優化",
      "enTitle": "Lesson 1: AI Resume Writing and Optimization",
    ...
    },
    {
      ...
      "chapterZh": "AI 求職與職涯發展",
      "chapterEn": "AI Job Search and Career Development",
      "zhTitle": "第2課：AI 自我介紹與個人故事",
      "enTitle": "Lesson 2: AI Self-Introduction and Personal Narrative",
    ...
    },
    {
      ...
      "chapterZh": "AI 求職與職涯發展",
      "chapterEn": "AI Job Search and Career Development",
      "zhTitle": "第3課：AI LinkedIn 個人品牌經營",
      "enTitle": "Lesson 3: AI LinkedIn Personal Branding",
    ...
    },
    {
      ...
      "chapterZh": "AI 求職與職涯發展",
      "chapterEn": "AI Job Search and Career Development",
      "zhTitle": "第4課：AI 面試模擬與回答技巧",
      "enTitle": "Lesson 4: AI Interview Simulation and Answering Skills",
    ...
    },
    {
      ...
      "chapterZh": "AI 求職與職涯發展",
      "chapterEn": "AI Job Search and Career Development",
      "zhTitle": "第5課：AI 求職策略與職涯規劃",
      "enTitle": "Lesson 5: AI Job Search Strategy and Career Planning",
    ...
    },
    {
      ...
      "zhTitle": "第6課：AI 個人網站與作品展示",
      "enTitle": "Lesson 6: Personal Website and Project Showcase",
    ...
    },
    {
      ...
      "chapterZh": "AI 個人專案與作品集",
      "chapterEn": "AI Personal Projects and Portfolio",
      "zhTitle": "第7課：AI 作品集整理與最終發表",
      "enTitle": "Lesson 7: Portfolio Curation and Final Presentation",
  ...
  "workplace-productivity": [
    {
      ...
      "chapterZh": "建立 AI 學習系統",
      "chapterEn": "Build Your AI Learning System",
      "zhTitle": "第1課：建立 AI Second Brain",
      "enTitle": "Lesson 1: Build an AI Second Brain",
    ...
    },
    {
      ...
      "zhTitle": "第2課：AI Word 與文件整理",
      "enTitle": "Lesson 2: AI Word and Document Organization",
    ...
    },
    {
      ...
      "chapterZh": "AI 學習生產力系統",
      "chapterEn": "AI Learning Productivity System",
      "zhTitle": "第3課：AI Excel 與資料處理",
      "enTitle": "Lesson 3: AI Excel and Data Handling",
    ...
    },
    {
      ...
      "chapterZh": "AI 學習生產力系統",
      "chapterEn": "AI Learning Productivity System",
      "zhTitle": "第4課：AI PowerPoint 與投影片製作",
      "enTitle": "Lesson 4: AI PowerPoint and Slide Production",
    ...
    },
    {
      ...
      "chapterZh": "AI 學習生產力系統",
      "chapterEn": "AI Learning Productivity System",
      "zhTitle": "第5課：AI Google Workspace 協作",
      "enTitle": "Lesson 5: AI Google Workspace Collaboration",
    ...
    },
    {
      ...
      "chapterZh": "AI 學習生產力系統",
      "chapterEn": "AI Learning Productivity System",
      "zhTitle": "第6課：AI Email 與學術溝通",
      "enTitle": "Lesson 6: AI Email and Academic Communication",
    ...
    },
    {
      ...
      "chapterZh": "AI 團隊協作與專案管理",
      "chapterEn": "AI Team Collaboration and Project Management",
      "zhTitle": "第7課：AI 會議紀錄與重點整理",
      "enTitle": "Lesson 7: AI Meeting Notes and Decision Capture",
    ...
    },
    {
      ...
      "chapterZh": "AI 團隊協作與專案管理",
      "chapterEn": "AI Team Collaboration and Project Management",
      "zhTitle": "第8課：AI 任務管理與進度追蹤",
      "enTitle": "Lesson 8: AI Task Management and Progress Tracking",
    ...
    },
    {
      ...
      "zhTitle": "第9課：建立個人 AI 知識管理系統",
      "enTitle": "Lesson 9: Build Your Personal AI Knowledge System",
  ...
  "startup-automation": [
    ...
    null,
    {
      ...
      "chapterZh": "AI 個人專案與作品集",
      "chapterEn": "AI Personal Projects and Portfolio",
      "zhTitle": "第3課：AI 專案主題發想與需求定義",
      "enTitle": "Lesson 3: Project ideation and requirements definition",
    ...
    null,
    {
      ...
      "chapterZh": "AI 個人專案與作品集",
      "chapterEn": "AI Personal Projects and Portfolio",
      "zhTitle": "第5課：AI 專案規劃與 MVP 設計",
      "enTitle": "Lesson 5: Project planning and MVP design",
    ...
    null,
    {
      ...
      "chapterZh": "AI 個人專案與作品集",
      "chapterEn": "AI Personal Projects and Portfolio",
      "zhTitle": "第7課：GitHub 專案管理與版本紀錄",
      "enTitle": "Lesson 7: GitHub project management and version history",
...
/* ==== PREMIUM_LESSON_ARCHIVE (do not delete) ==== */
const PREMIUM_LESSON_ARCHIVE = {
  "description": "未納入定稿或被合併的教材正文備份（不可刪）。",
  "unusedCount": 26,
  "items": [
    {
      "source": "admissions[8]",
      "reason": "定稿以志願比較取代個人 AI 升學顧問",
      "lesson": {
        "zhTitle": "第9課：建立你的個人 AI 升學顧問",
        "enTitle": "Lesson 9: 建立你的個人 AI 升學顧問",
        "zhConcept": "這一課要建立一個可以反覆使用的個人背景 Prompt。你不用每次重新說明自己是誰，而是讓 AI 根據你的目標科系、優勢、弱點、素材與進度給出更個人化的建議。",
    ...
    {
      "source": "college-learning[4]",
      "reason": "Second Brain 與知識庫合併",
      "lesson": {
        "icon": "🗂️",
        "title": "建立 AI Second Brain",
        "description": "把筆記、來源、模板與任務連結成可檢索的第二大腦，形成 Chapter 1 的完整系統。",
    ...
    {
      "source": "college-learning[2]",
      "reason": "未納入定稿六門課（重複、越界或已合併）",
      "lesson": {
        "icon": "🧰",
        "title": "認識 AI 工具",
...
const PREMIUM_RESTRUCTURE_REPORT = {
  "moves": [
    "college-learning 原第1課 → college-learning L1「為什麼大學生需要學習系統，而不是只會問 AI」",
    "college-learning 原第2課 → college-learning L2「建立 AI 學習工作區」",
    "college-learning 原第4課 → college-learning L3「為讀書與作業寫出可用的 Prompt」",
    "college-learning 原第57課 → college-learning L4「用 AI 安排一週課表與讀書優先順序」",
    "college-learning 原第11課 → college-learning L5「用 AI 做課堂筆記：聽得懂、找得到、複習得了」",
    "college-learning 原第12課 → college-learning L6「用 AI 消化教材與 PDF，抓出作業與考試重點」",
    "college-learning 原第17課 → college-learning L7「用 AI 讀懂作業要求，排出課堂報告大綱」",
    "college-learning 原第21課 → college-learning L8「用 AI 規劃課堂報告簡報結構」",
    "college-learning 原第26課 → college-learning L9「用 AI 建立考試複習清單與練習節奏」",
    "college-learning 原第31課 → college-learning L10「用 AI 提升英文閱讀，讀懂原文教材與作業」",
    "college-learning 原第46課 → research-competition L1「把興趣變成可研究的題目」",
    "college-learning 原第44課 → research-competition L2「縮小範圍，寫出研究問題與假設」",
    "college-learning 原第7課 → research-competition L3「用 AI 協助學術搜尋，找到關鍵文獻與來源」",
    "college-learning 原第10課 → research-competition L4「用 AI 精讀文獻：摘要、比較與查證」",
    "college-learning 原第18課 → research-competition L5「建立文獻筆記與引用格式」",
    "college-learning 原第14課 → research-competition L6「整理文獻觀點，建立比較與筆記結構」",
    "college-learning 原第45課 → research-competition L8「整理分析結果，寫出專題論點結構」",
    "college-learning 原第22課 → research-competition L9「製作研究／競賽提案簡報」",
    "college-learning 原第25課 → research-competition L10「完成研究／專題／競賽專案包的口頭提案準備」",
    "college-learning 原第51課 → career-internship L4「用 AI 建立並優化履歷（對準職缺，不造假）」",
    "college-learning 原第54課 → career-internship L6「建立 30 秒／1 分鐘／3 分鐘自我介紹」",
    "college-learning 原第52課 → career-internship L7「用 AI 經營 LinkedIn 個人品牌檔案」",
    "college-learning 原第50課 → career-internship L8「整理作品集架構，證明你做過什麼」",
    "college-learning 原第53課 → career-internship L9「建立面試題庫，做企業模擬面試與修正」",
    "college-learning 原第55課 → career-internship L10「整合完成「求職與實習申請包」與投遞節奏」",
    "college-learning 原第40課 → workplace-productivity L2「用 AI 處理 Email 與專業溝通」",
    "college-learning 原第42課 → workplace-productivity L3「用 AI 整理會議紀錄、決策與待辦」",
    "college-learning 原第36課 → workplace-productivity L4「用 AI 撰寫與整理商務文件」",
    "college-learning 原第37課 → workplace-productivity L5「用 AI 處理表格與數據初稿」",
    "college-learning 原第38課 → workplace-productivity L6「用 AI 製作工作簡報（對內／對外）」",
    "college-learning 原第56課 → workplace-productivity L8「建立個人或團隊知識庫（第二大腦／企業知識）」",
    "college-learning 原第43課 → workplace-productivity L9「用 AI 做任務管理、優先順序與週期回報」",
    "college-learning 原第39課 → workplace-productivity L10「整合完成「個人 AI 工作流程系統」」",
    "college-learning 原第47課 → startup-automation L4「規劃 MVP：最小可驗證產品與功能取捨」",
    "college-learning 原第48課 → startup-automation L6「用 GitHub 與版本思維管理產品迭代」"
  ],
  "merges": [
    "學習課：教材／PDF 相關重複課併入「消化教材與 PDF」",
    "學習課：考試系列重複課併入「考試複習清單與練習節奏」",
    "研究課：搜尋工具課收斂為「學術搜尋」能力課",
    "研究課：提案簡報改能力導向標題（不以工具名作課名）",
    "求職課：個人網站與作品集合併為「作品集架構」",
    "職場課：Second Brain 與知識管理合併為「知識庫」一堂"
  ],
  "kept": [
    "admissions 原第1課 → admissions L1",
    "admissions 原第2課 → admissions L2",
    "admissions 原第3課 → admissions L4",
    "admissions 原第4課 → admissions L5",
    "admissions 原第5課 → admissions L6",
    "admissions 原第6課 → admissions L7",
    "admissions 原第7課 → admissions L8",
    "admissions 原第8課 → admissions L9",
    "admissions 原第10課 → admissions L10"
  ],
  "created": [
    "admissions-L3 用 AI 比較校系，建立志願選擇邏輯",
    "research-competition-L7 設計研究方法：問卷、訪談或資料收集架構",
    "career-internship-L1 盤點可寫進履歷的真實經驗與能力證據",
    "career-internship-L2 用 STAR 把經驗寫成可驗證的成果描述",
    "career-internship-L3 鎖定目標實習／職缺，拆解職缺需求",
    "career-internship-L5 用 AI 撰寫求職信與 Cover Letter",
    "workplace-productivity-L1 建立職場 AI 工作觀：什麼自己做、什麼交給 AI",
    "workplace-productivity-L7 用 AI 建立 SOP 與標準作業流程",
    "startup-automation-L1 用 AI 定義真實問題與市場機會",
    "startup-automation-L2 分析目標使用者與痛點，設計訪談問題",
    "startup-automation-L3 建立商業模式草稿：誰付錢、為何付錢",
    "startup-automation-L5 用 AI 拆解產品規格與開發任務",
    "startup-automation-L7 設計 Pitch Deck：讓別人聽懂你的生意",
    "startup-automation-L8 建立自動化思維：把重複工作變成流程",
    "startup-automation-L9 認識自動化與 AI Agent：何時用人、何時用機器",
    "startup-automation-L10 整合完成「創業提案＋基礎 AI 自動化流程」"
  ],
  "id_changes": [
    "admissions-L1 @ admissions index 0",
    "admissions-L2 @ admissions index 1",
    "admissions-L3 @ admissions index 2",
    "admissions-L4 @ admissions index 3",
    "admissions-L5 @ admissions index 4",
    "admissions-L6 @ admissions index 5",
    "admissions-L7 @ admissions index 6",
    "admissions-L8 @ admissions index 7",
    "admissions-L9 @ admissions index 8",
    "admissions-L10 @ admissions index 9"
  ]
};
