...
const I18N = {
  zh: {
    ...
    home: {
      ...
      title: "人人都能學會 AI，<br>打造真正有價值的技能。",
      lead: "AI Skill Bridge 幫助學生、上班族、創作者與企業，快速學會 AI、建立作品集、提升工作效率。",
      start: "立即免費開始",
      watchCourses: "觀看課程",
      dashboardTitle: "AI Learning Dashboard",
      dashboardSubtitle: "你的學習中心",
      ...
      dashLessonUnit: "lessons",
      dashBadgeUnit: "badges",
      activity1: "完成 Prompt 基礎練習",
      activity2: "儲存 AI 工作流程筆記",
      activity3: "獲得學習徽章",
      toolsTitle: "Trusted by AI Tools",
      toolsLead: "掌握各類 AI 工作流程必備的核心技能。",
      toolChat: "Chat AI",
      toolPrompt: "Prompt",
      toolAutomation: "Automation",
      toolDesign: "Design",
      toolCoding: "Coding",
      toolAnalytics: "Analytics",
      whyTitle: "Why AI Skill Bridge?",
      whyLead: "為真正想學會的人而設計 — 不只是看教程。",
      why1: "學得快",
      why1Desc: "互動式課程與測驗，3 分鐘就知道從哪裡開始。",
      why2: "做得到",
      why2Desc: "每課都有實作任務，產出可交付的成果。",
      why3: "立即套用",
      why3Desc: "40+ Prompt 模板，學完就能用在日常工作中。",
      why4: "持續更新",
      why4Desc: "雙語內容、新工具導航與進階路徑持續擴充。",
      outcomesTitle: "你可以完成的 AI 成果",
      outcomesLead: "從基礎操作到專案作品集，每個階段都有具體可交付的成果。",
      outcome1: "AI 基礎操作",
      outcome1Desc: "從零開始認識 AI 工具，學會日常任務中的基本操作與提問方式。",
      outcome2: "Prompt Engineering",
      outcome2Desc: "掌握角色、格式、限制等 Prompt 技巧，讓 AI 回答更精準有用。",
      outcome3: "AI 工作流程",
      outcome3Desc: "把 AI 嵌入讀書、寫作、整理資料等重複性工作，建立可重用的流程。",
      outcome4: "AI 自動化",
      outcome4Desc: "了解如何用 AI 串接任務、節省時間，為進階應用打好基礎。",
      outcome5: "AI 專案作品集",
      outcome5Desc: "完成可展示的 AI 實作成果，作為學習證明或職涯作品集。",
  ...
  en: {
    ...
    home: {
      badge: "🚀 AI Learning Platform",
      title: "Everyone Can Learn AI,<br>Build Skills That Actually Matter.",
      lead: "AI Skill Bridge helps students, professionals, creators, and teams learn AI fast — build portfolios and boost productivity.",
      start: "Start Free Now",
      watchCourses: "Browse Courses",
      dashboardTitle: "AI Learning Dashboard",
      dashboardSubtitle: "Your learning hub",
      dashProgress: "Learning Progress",
      dashTools: "AI Tools",
      dashProjects: "Projects",
      dashCertificates: "Certificates",
      ...
      dashLessonUnit: "lessons",
      dashBadgeUnit: "badges",
      activity1: "Completed Prompt basics",
      activity2: "Saved AI workflow notes",
      activity3: "Earned learning badge",
      toolsTitle: "Trusted by AI Tools",
      toolsLead: "Learn the skills behind every major AI workflow category.",
      toolChat: "Chat AI",
      toolPrompt: "Prompt",
      toolAutomation: "Automation",
      toolDesign: "Design",
      ...
      toolAnalytics: "Analytics",
      whyTitle: "Why AI Skill Bridge?",
      whyLead: "Built for learners who want results — not just tutorials.",
      why1: "Learn Fast",
      why1Desc: "Interactive lessons and quizzes — know where to start in minutes.",
      why2: "Get It Done",
      why2Desc: "Every lesson includes hands-on tasks and real deliverables.",
      why3: "Apply Instantly",
      why3Desc: "40+ prompt templates ready to use in your daily work.",
      why4: "Always Updated",
      why4Desc: "Bilingual content, tool guides, and premium tracks keep expanding.",
      outcomesTitle: "AI Outcomes You Can Complete",
      outcomesLead: "From basics to project portfolios — concrete deliverables at every stage.",
      outcome1: "AI Basics",
      outcome1Desc: "Start from zero: learn core AI tools and how to ask useful questions.",
      outcome2: "Prompt Engineering",
      outcome2Desc: "Master role, format, and constraints for sharper AI answers.",
      outcome3: "AI Workflows",
      outcome3Desc: "Embed AI into study, writing, and organizing — build reusable workflows.",
      outcome4: "AI Automation",
      outcome4Desc: "Chain tasks with AI, save time, and prepare for advanced applications.",
      outcome5: "AI Project Portfolio",
      outcome5Desc: "Finish showcase-ready projects as proof of learning or career portfolio pieces.",
