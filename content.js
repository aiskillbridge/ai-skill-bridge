...
const I18N = {
  zh: {
    ...
    home: {
      ...
      faq5Q: "有中英雙語嗎？",
      faq5A: "有。可隨時在頁首切換中文與 English。</p></details><details class=\"home-faq-item\"><summary>購買後如何開始使用？</summary><p>購買完成後，登入帳號即可立即解鎖 Premium 課程與模板。打開課程地圖、進入進階路徑，依步驟完成專案就能開始使用。",
