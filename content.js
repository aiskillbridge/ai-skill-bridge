...
const I18N = {
  zh: {
    ...
    home: {
      eyebrow: "專為高二、高三學生與家長設計",
      title: "用 AI 完成你的大學申請準備",
      lead: "從科系探索、學習歷程、自述到面試，AI Skill Bridge 帶你一步一步完成。",
      start: "免費開始",
      premium: "查看進階課程",
      outcomesTitle: "完成課程後，你會擁有",
      outcomesLead: "不是零散的 AI 技巧，而是一份能直接使用的完整大學申請包。",
      outcome1: "大學申請地圖",
      outcome1Desc: "清楚知道要申請哪些科系、現在該做什麼、下一步是什麼。",
      outcome2: "學習歷程素材庫",
      outcome2Desc: "把高中三年的活動、競賽、服務整理成可引用的素材。",
      outcome3: "多元表現整理",
      outcome3Desc: "用 AI 協助歸類與描述，讓每段經歷都有重點。",
      outcome4: "學習歷程自述",
      outcome4Desc: "從草稿到修改，產出有邏輯、有個人特色的自述。",
      outcome5: "面試題庫",
      outcome5Desc: "常見面試題與模擬練習，面試前可以反覆準備。",
  ...
  en: {
    ...
    home: {
      eyebrow: "For Grade 11–12 Students & Parents",
      title: "Complete Your University Application Prep with AI",
      lead: "From major exploration to learning portfolios, personal statements, and interviews — AI Skill Bridge guides you step by step.",
      start: "Start Free",
      premium: "View Premium Courses",
      outcomesTitle: "What You'll Have After Completing the Course",
      outcomesLead: "Not scattered AI tips — a complete university application package you can actually use.",
      outcome1: "University Application Map",
      outcome1Desc: "Know which majors to apply for, what to do now, and what comes next.",
      outcome2: "Learning Portfolio Library",
      outcome2Desc: "Organize three years of activities, competitions, and service into reusable materials.",
      outcome3: "Diverse Performance Summary",
      outcome3Desc: "Use AI to categorize and describe each experience with clear focus.",
      outcome4: "Learning Portfolio Statement",
      outcome4Desc: "From draft to revision — produce a logical, personal statement.",
      outcome5: "Interview Question Bank",
      outcome5Desc: "Common interview questions and practice drills you can repeat before the real interview.",
      ...
      after1: "Complete application package",
      after2: "Know the next step",
      after3: "AI helps revise content",
      featuresTitle: "What's Included",
      featuresLead: "One purchase — 10 hands-on lessons take you from zero to a finished application package.",
      ...
      feature3: "University Application Package",
      feature3Desc: "Major exploration, portfolio, statement, and interview prep — all in one.",
      feature4: "AI Coach Feedback",
      feature4Desc: "Guided practice so AI helps you revise and improve your content.",
      ctaTitle: "Start Preparing Your University Application Now",
      ctaLead: "Try the free intro first, then upgrade to the full course when you're ready.",
      ctaStart: "Start Free Now",
      ctaPremium: "Upgrade to Full Course",
      priceHint: "Premium from NT$499 · Lifetime access"
    },
    courses: {
